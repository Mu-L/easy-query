...
public class MyTest2 extends BaseTest {
    ...
    public void testTuple1() {
        ...
        List<Tuple2<String, Integer>> list2 = easyEntityQuery.queryable(BlogEntity.class)
                .where(o -> {
...
//                    LocalDateTime.now().plus(1, TimeUnitEnum.MILLISECONDS)
    ...
    public void testTuple3() {
        {
            Tuple1<LocalDateTime> localDateTimeTuple1 = easyEntityQuery.queryable(BlogEntity.class)
                    .select(o -> Select.TUPLE.of(
                            o.createTime()
                    )).firstOrNull();
            Assert.assertNotNull(localDateTimeTuple1);
            LocalDateTime value1 = localDateTimeTuple1.getValue1();
    ...
    public void testTuple6() {
        ...
        Tuple3<LocalDateTime, LocalDateTime, LocalDateTime> draft3 = easyEntityQuery.queryable(BlogEntity.class)
                .whereById(id)
                .where(o -> {
    ...
    public void testTuple7() {
        ...
        Tuple7<Integer, Integer, Integer, Integer, Integer, Integer, Integer> draft3 = easyEntityQuery.queryable(BlogEntity.class)
                .whereById(id)
                .where(o -> {
    ...
    public void testTuple9() {
        ...
        Tuple7<Long, Long, Long, Long, Long, Long, Long> draft3 = easyEntityQuery.queryable(BlogEntity.class)
                .whereById(id)
                .select(o -> Select.TUPLE.of(
...
//                        content().set(o.title().subString(1, 2).asAny().toStr());
    ...
    public void testSelect7() {
        ...
        ListenerContext listenerContext = new ListenerContext();
        listenerContextManager.startListen(listenerContext);
        List<Tuple2<String, Long>> list = easyEntityQuery.queryable(Topic.class)
                .where(o -> {
                    o.title().isNotNull();
                    o.createTime().le(LocalDateTime.of(2021, 3, 4, 5, 6));
                })
                .select(o -> Select.TUPLE.of(o.title(), o.title().subString(1, 2)))
...
//        Assert.assertEquals("2023-03-04T05:06(LocalDateTime)", EasySQLUtil.sqlParameterToString(jdbcExecuteAfterArg.getBeforeArg().getSqlParameters().get(0)));
    ...
    public void testGroup18() {
        ...
        for (Tuple2<String, Long> stringLongTuple2 : list) {

            if ("12".equals(stringLongTuple2.getValue1())) {
                Assert.assertEquals(97L, (long) stringLongTuple2.getValue2());
            }
        }
    }
    ...
    public void testGroup19() {
        ...
        List<Tuple3<String, BigDecimal, Long>> list = easyEntityQuery.queryable(Topic.class)
    ...
    public void testGroup21() {
        ...
        List<Tuple2<String, Long>> list1 = easyEntityQuery.queryable(Topic.class)
                .leftJoin(BlogEntity.class, (t, t1) -> t.id().eq(t1.id()))
                .where((t, t1) -> {
                    t.id().isNotNull();
                    t1.score().isNotNull();
        ...
        listenerContextManager.clear();
        for (Tuple2<String, Long> stringLongTuple2 : list1) {

            String value1 = stringLongTuple2.getValue1();
            Long value2 = stringLongTuple2.getValue2();
        }
    ...
    public void testGroup22() {
        ...
        List<Tuple2<LocalDateTime, Long>> list1 = easyEntityQuery.queryable(Topic.class)
                .leftJoin(BlogEntity.class, (t, t1) -> t.id().eq(t1.id()))
                .where((t, t1) -> {
                    t.id().isNotNull();
                    t1.score().isNotNull();
        ...
        listenerContextManager.clear();
        for (Tuple2<LocalDateTime, Long> stringLongTuple2 : list1) {

            LocalDateTime value1 = stringLongTuple2.getValue1();
            Long value2 = stringLongTuple2.getValue2();
        }
