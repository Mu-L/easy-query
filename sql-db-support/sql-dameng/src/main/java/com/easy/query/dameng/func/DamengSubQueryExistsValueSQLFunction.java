 ...
 * @author xuejiaming
 */
public class DamengSubQueryExistsValueSQLFunction extends AbstractExpressionSQLFunction {
    private final List<ColumnExpression> columnExpressions;

    public DamengSubQueryExistsValueSQLFunction(List<ColumnExpression> columnExpressions) {
