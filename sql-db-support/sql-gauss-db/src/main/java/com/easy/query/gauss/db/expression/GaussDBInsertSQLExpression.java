 ...
 * @author xuejiaming
 */
public class GaussDBInsertSQLExpression extends InsertSQLExpressionImpl {
    public GaussDBInsertSQLExpression(EntitySQLExpressionMetadata entitySQLExpressionMetadata, EntityTableSQLExpression table) {
