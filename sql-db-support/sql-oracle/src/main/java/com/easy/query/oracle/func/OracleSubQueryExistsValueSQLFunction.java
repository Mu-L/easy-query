 ...
 * @author xuejiaming
 */
public class OracleSubQueryExistsValueSQLFunction extends AbstractExpressionSQLFunction {
    private final List<ColumnExpression> columnExpressions;

    public OracleSubQueryExistsValueSQLFunction(List<ColumnExpression> columnExpressions) {
