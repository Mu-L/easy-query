 ...
 * @author xuejiaming
 */
public class DuckDBSQLInsertSQLExpression extends InsertSQLExpressionImpl {
    public DuckDBSQLInsertSQLExpression(EntitySQLExpressionMetadata entitySQLExpressionMetadata, EntityTableSQLExpression table) {
